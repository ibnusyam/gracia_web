function initialize() {
    ...
    // Multiple Markers
    var markers = [
        ['PT. Gracia Pharmindo, Bandung', -6.9195188,107.6215845],
        ['PT. Gracia Pharmindo, Rancaekek', -6.959671,107.7960284],
    ...
    var infoWindowContent = [
        ...
        '<h3>PT. Gracia Pharmindo / Head Office</h3>' +
        '<p>Jl. Baranang Siang Komplek ITC Kosambi Blok G-27, Bandung 40112, Indonesia</p>' +        '</div>'],
        ['<div class="info_content">' +
        '<h3>PT. Gracia Pharmindo / Factory</h3>' +
        '<p>Kawasan Industri Dwipapuri Blok M-30, Jl. Raya Rancaekek km 24.5, Bandung 45364, Indonesia</p>' +
        '</div>']
    ];

    // Multiple Pointers with Different Colors
    var mapPointers = [
        ['../webmin_scr/images/map-marker.png'],
        ['../webmin_scr/images/map-marker2.png'],
        ['../webmin_scr/images/map-marker3.png']
    ];
