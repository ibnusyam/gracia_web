            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="modern-card" style="background: #fff; border-radius: 12px; padding: 40px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); border: 1px solid #f0f0f0;">
                    ...
                    <div style="margin-bottom: 25px;">
                        <h3 class="page-title" style="font-weight: 800; color: #1e293b; margin-top: 0; margin-bottom: 5px;">Tambah Akun Baru</h3>
                        <p style="color: #94a3b8; font-size: 14px;">Buat *username* dan *password* untuk staf baru.</p>
                    ...
                    <form action="{{ url('admin/store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="username" class="form-control" type="text" value="{{ old('username') }}" placeholder="Ketikkan username tanpa spasi (cth: budi_hrd)" required>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label style="color: #475569; font-weight: 600;">Password <small class="text-danger">*</small></label>
                                    <input name="password" class="form-control" type="password" placeholder="Minimal 5 karakter" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="level" class="form-control" required>
                                        ...
                                        <option value="admin" {{ old('level') == 'Admin' ? 'selected' : '' }}>Admin (Super User)</option>
                                        <option value="hrd" {{ old('level') == 'HRD' ? 'selected' : '' }}>HRD</option>
                                        <option value="produk" {{ old('level') == 'Produk' ? 'selected' : '' }}>Marketing</option>
                                    </select>
